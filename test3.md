...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/Installningat-grunder.png)
...
Informera mottagaren om statusändringar som har skett med deras order, inklusive meddelanden som:
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/lagg-till-ny-leveransgrupp.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/leveransgrupper-1.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/Avsandare-1.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/skapa-avsandare-2.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/e-post.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/temq.png)

![Image](https://docs.pindeliver.com/images/sender_theme_customer_page_1.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/trafikbegransningar.png)

Klicka på Lägg till ny trafikregion under listan för att skapa en ny trafikregion.

![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/screencapture-cloud-pindeliver-trafficRegions-add-2024-12-06-09_42_29.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/karta.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/Goteborg-karta.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/trafikregion.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/Meddelande.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/Meddelandemall.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/Valj-kunder.png)
...
![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/meddelande-mall-show-selection.png)

# Go App Sv

## GO-app

Go-appen inkluderar även funktioner för:

Observera att dessa funktioner inte demonstreras i videoklippen ovan.

# Hubb App

## Hubb-app

Hubb-appen är utformad för användning i terminaler eller lager för att effektivisera och förbättra hanteringen av varor, vilket förbättrar den dagliga driften och

minskar leveransfel. Dessutom erbjuder den en praktisk lösning för att hantera paket relaterade till Click & Collect-beställningar. Användare kan skanna kundinformationssidan när kunder anländer för att hämta sina paket för Click & Collect-beställningar, vilket gör processen smidigare och mer effektiv.

Bilden nedan ger ett exempel på Hubb-appen, där de inställningar som beskrivs vidare bestämmer vilka alternativ och knappar som är synliga och åtkomliga i Hubb-appen.

![Image](https://docs.pindeliver.com/wp-content/uploads/2024/11/Screenshot-2024-11-20-at-15.15.10-1-604x1024.png)

![Image](https://docs.pindeliver.com/wp-content/uploads/2024/12/Installningar-hubbappen.png)

Funktioner för sortera paket och ankomstskanning

Funktioner för information om paket samt slå samman paket
...
## Leverans utan mottagare


## Leveransen kunde inte slutföras

Om leveransen inte kunde slutföras är det rekommenderat att ge kunden instruktioner om hur de ska gå vidare. Genom att länka till statussidan och inkludera foton får kunden visuell bevisning på att föraren har försökt att leverera vid deras plats.
...
Vårt verktyg för leveransuppföljning är en robust lösning utformad för att förbättra effektiviteten i din leveranshanteringsprocess. Med en omfattande översikt över alla leveranser inom en angiven tidsram erbjuder pinDeliver en rad funktioner för att förenkla denna process. Vad som verkligen utmärker vårt system är dess flexibilitet. Du kan sortera leveranser baserat på olika kriterier, såsom datum, ordertyp, avsändare, leveransgrupper, ackumulering och kommande rutter, vilket ger dig möjlighet att snabbt få tillgång till den mest relevanta informationen.

Genom att klicka på ett objekt i tabellen får du tillgång till en detaljerad vy över leveransstatus för rutterna på den valda dagen, vilket underlättar en noggrann analys. Dessutom, när du behöver dela eller analysera data vidare, kan du enkelt ladda ner en Excel-fil direkt från leveransstatussidan.

Med uppföljningsverktyget sitter du i förarsätet och förenklar beslutsfattandet genom insikter baserade på data. Säg adjö till leveransrelaterade utmaningar och välkomna en smidigt hanterad leveransprocess. Vi uppmuntrar dig att prova det själv och upplev skillnaden det kan göra.

## Obehandlade Leveranser

Vår vy för Obehandlade Leveranser är din lösning för att effektivt spåra obehandlade leveranser. Sortera enkelt efter datum, ordertyp och leveransgrupper, och klicka dig vidare för att få tillgång till detaljerad information om rutterna, inklusive en kartvy över stoppen, viktiga detaljer och exakta beräknade ankomsttider för kunderna.

## Delleveranser

Vår spårare för Delleveranser är ett kraftfullt verktyg för effektiv övervakning av delleveranser. Organisera leveranser enkelt efter datum och grupper, med klickbara länkar för detaljerade orderuppgifter, insikter om leveransrutter och kundinformation. Håll koll på interna anteckningar och få tillgång till en omfattande händelselogg för varje kund. Kopiera kunduppgifter mellan order eller rutter och exportera all data till Excel för djupgående analys och rapportering.

## Körningar

Vårt verktyg för Körningar erbjuder effektiv sortering efter datum, leveransgrupp, låst/olåst status, tilldelad status och övergripande status, med realtidsuppdateringar av data. Detaljerad insikt i varje tilldelning inkluderar schemalagt datum, start- och sluttider, vikt, volym, status och mer, vilket ger en omfattande översikt för analys. Exportera enkelt till Excel eller visa i Office-gränssnittet, med detaljerad rutt- och orderinformation bara ett klick bort, kompletterat med en händelselogg. Den fullt sökbara listan ger ytterligare bekvämlighet, förbättrar kontrollen och effektiviserar processerna. Utforska funktionaliteten i detta verktyg för optimerade operationer.

## Uppdrag

Vår Uppdragsvy erbjuder en omfattande översikt över alla uppdrag inom din angivna tidsram. Sortera effektivt efter datum, leveransgrupp, avsändare och uppdragsstatus. Få tillgång till detaljerad information inklusive uppdragstyp, kunduppgifter, paketspecifikationer, leveransbevis, meddelanden och avvikelser. Använd sökfunktionen för snabb åtkomst och exportera data smidigt till Excel. Detta förbättrar spårningen och kontrollen av uppdragen samtidigt som det underlättar effektiv kommunikation och problemlösning för överlägsen kundservice.

## Realtidsuppföljning

Vår Realtidsuppföljning ger dig en inblick i alla rutter som antingen har startat eller är planerade att börja inom x antal minuter. Med flexibiliteten att justera uppdateringsfrekvensen får du realtidsuppdateringar. Den detaljerade listan inkluderar viktig information om rutten, leveransgrupp, planerade och faktiska tider, varningar, förseningar, prognoser för ruttens slutförande, återstående leveranser och den tilldelade föraren. Utforska Realtidsrapporten för en uppdaterad översikt av aktiviteter.

## Realtidskarta

Vår Realtidskarta är din visuella guide till alla aktiva rutter. Du kan enkelt begränsa visningen genom att sortera efter leveransgrupper. Kartan uppdateras varje minut, och du kan anpassa auto-zoomfunktionen efter dina preferenser. Genom att klicka på en fordonsikon får du detaljerad information om den aktuella resan. Utforska Realtidskartan för en dynamisk och uppdaterad vy över dina aktiva rutter.

## Rapporter

Vårt Rapportverktyg är en viktig funktion som ger dig möjlighet att anpassa Excel-filer med detaljerad information om rutter inom en specifik tidsram. Skräddarsy din rapport genom att välja kriterier som leveransgrupper, datum, avsändare och leveransstatus. Dessutom finns alternativ för att inkludera rutter som ännu inte har startat. Rapporten erbjuds i både standard- och utökade versioner, båda i Excel-format. Utforska Rapportverktyget för en mer personlig och insiktsfull upplevelse.

## Meddelandelogg

Vår Meddelandelogg är ett omfattande verktyg utformat för att visa alla meddelanden som skickats inom en specifik tidsram. Med Meddelandeloggen har du flexibiliteten att sortera meddelanden efter datum, meddelandestatus, typ och avsändare. Spåra enkelt varje meddelandes rutt, skilj mellan meddelandetyper (SMS eller e-post), visa telefonnummer, tidsstämplar för sändning och leverans, meddelandeinnehåll och leveransstatus i loggen. Exportera hela loggen till en Excel-fil för extra bekvämlighet och använd sökfunktionen för snabb åtkomst. Utforska Meddelandeloggen för en mer omfattande och organiserad översikt av din kommunikationshistorik.

## Ruttanalys

Vårt Ruttanalysverktyg erbjuder en omfattande översikt över avslutade rutter inom din angivna tidsram, med enkel sortering efter datum och leveransgrupper. Tabellen ger detaljerad data för beräknad tid, tillsammans med en jämförelse med faktisk tid, allt nedladdningsbart i Excel-format. Genom att klicka på ett ruttnamn får du en detaljerad vy över varje stopp och en motsvarande graf, som också kan laddas ner i Excel-format. Detta verktyg är utformat för att öka kontrollen och effektivisera processerna, och ger värdefulla insikter för djupgående ruttanalys.

## Prognos för Förpackningstyp

Prognos för Förpackningstyp erbjuder en detaljerad översikt över enskilda order baserat på vikt, volym och ADR-poäng. Sortera enkelt order efter fordonstaggar, stad eller avsändare och stopptyp för enkel navigering. Den centrala tabellen ger en omfattande sammanfattning av alla orderparametrar, inklusive stopp, ADR-poäng, vikt, volym och totalvolym, medan den nedre tabellen bryter ner siffrorna baserat på din valda gruppering. Ladda ner hela listan i Excel-format för vidare analys. Utforska vyn för en detaljerad genomgång.

## Flyttuppdrag

Vi förenklar hanteringen av alla flyttuppdrag inom din angivna tidsram. Sortera enkelt efter datum, ruttnamn, leveransgrupp och slutförandestatus. Varje post ger tydlig kundinformation med detaljer om ursprungs- och destinationszoner samt rutter, antal paket, slutförandestatus, utförare och skapelsedatum. Du kan enkelt radera eller slutföra enskilda eller flera uppgifter direkt från Office-gränssnittet. Exportera hela listan till Excel för vidare analys. Utforska verktyget för flyttuppdrag för en förenklad och organiserad översikt.

## Körjournaler

Vårt verktyg för körjournaler ger en omfattande översikt över alla köraktiviteter inom en angiven tidsram. Sortera enkelt journaler efter datum och leveransgrupp för smidig navigering. Klicka på valfritt ruttnamn för att få detaljerad information, inklusive start- och sluttider, körsträcka, temperaturförhållanden, föraruppgifter och kommentarer. Exportera hela listan till Excel för extra bekvämlighet. Utforska verktyget för körjournaler för en detaljerad och lättillgänglig översikt över dina köraktiviteter.
